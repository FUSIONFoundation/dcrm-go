...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gfsn.ipc", false, filepath.Join(os.TempDir(), "gfsn.ipc")},
		{"data", "gfsn.ipc", false, "data/gfsn.ipc"},
		{"data", "./gfsn.ipc", false, "./gfsn.ipc"},
		{"data", "/gfsn.ipc", false, "/gfsn.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gfsn.ipc", true, `\\.\pipe\gfsn.ipc`},
		{"data", "gfsn.ipc", true, `\\.\pipe\gfsn.ipc`},
		{"data", `\\.\pipe\gfsn.ipc`, true, `\\.\pipe\gfsn.ipc`},
	}
