...
func TestParseEnsAPIAddress(t *testing.T) {
	for _, x := range []struct {
	...
	}{
		{
			...
			value:       "/data/testnet/gfsn.ipc",
			endpoint:    "/data/testnet/gfsn.ipc",
		},
		{
		...
		},
		{
			...
			value:       "test:/data/testnet/gfsn.ipc",
			endpoint:    "/data/testnet/gfsn.ipc",
			tld:         "test",
		},
		{
		...
		},
		{
			...
			value:       "314159265dD8dbb310642f98f50C066173C1259b@/data/testnet/gfsn.ipc",
			endpoint:    "/data/testnet/gfsn.ipc",
		...
		},
		{
			...
			value:       "test:314159265dD8dbb310642f98f50C066173C1259b@/data/testnet/gfsn.ipc",
			endpoint:    "/data/testnet/gfsn.ipc",
			addr:        common.HexToAddress("314159265dD8dbb310642f98f50C066173C1259b"),
			tld:         "test",
		},
