...
import (
	...
	"github.com/fusion/go-fusion/internal/jsre"
	"github.com/fusion/go-fusion/internal/web3ext"
...
func (c *Console) Welcome() {
	// Print some generic Gfsn metadata
	fmt.Fprintf(c.printer, "Welcome to the Gfsn JavaScript console!\n\n")
	c.jsre.Run(`
