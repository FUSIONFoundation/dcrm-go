...
import (
	...
	"github.com/fusion/go-fusion/signer/core"
	"github.com/fusion/go-fusion/signer/rules"
	"github.com/fusion/go-fusion/signer/storage"
...
func init() {
	app.Name = "Clef"
	app.Usage = "Manage Fusion account operations"
	app.Flags = []cli.Flag{
		logLevelFlag,
		keystoreFlag,
		configdirFlag,
