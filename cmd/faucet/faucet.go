...
import (
	...
	"github.com/fusion/go-fusion/ethstats"
	"github.com/fusion/go-fusion/les"
...
var (
	...
	netFlag     = flag.Uint64("network", 0, "Network ID to use for the Fusion protocol")
	...
	logFlag    = flag.Int("loglevel", 3, "Log level to use for Fusion and the faucet")
)
...
func authTwitter(url string) (string, string, common.Address, error) {
	...
	if address == (common.Address{}) {
		return "", "", common.Address{}, errors.New("No Fusion address found to fund")
	}
	var avatar string
